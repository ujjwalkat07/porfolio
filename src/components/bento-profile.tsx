...
export function BentoProfile() {
  ...
  return (
    <section className="w-full pt-10 pb-8 border-b border-border/40">
      ...
      {/* About paragraph */}
      <p className="text-sm text-neutral-400 font-light leading-relaxed max-w-3xl mb-6 text-justify">
